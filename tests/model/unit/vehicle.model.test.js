...
describe('Vehicle Model Tests', () => {
  ...
  // Tests de validation de la marque

  it('rejette les marques vides', async () => {
    const errors = createSequelizeErrors();
    mockVehicleModel.create.mockRejectedValue(errors.validation);

    await expect(mockVehicleModel.create({
      marque: '',
      model: 'Test',
  ...
  // Tests de validation de l'immatriculation
  ...
  it('rejette les immatriculations en double', async () => {
    const errors = createSequelizeErrors();
    mockVehicleModel.create.mockRejectedValue(errors.unique);
  ...
  // Tests de validation des années
  ...
  it('accepte les années valides', async () => {
    ...
    mockVehicleModel.create.mockResolvedValue(vehicle);

    const result = await mockVehicleModel.create({
      marque: 'Toyota',
      model: 'Corolla',
      immatriculation: 'TEST-123',
      annees: 2023,
  ...
  // Tests de validation du prix de location
