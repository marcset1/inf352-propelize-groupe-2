import { test, expect } from '@playwright/test';
   ...
   test.describe('Propelize Application Tests', () => {
     test.beforeEach(async ({ page }) => {
       ...
       await page.goto('http://localhost:3000'); // Adjust to your local server URL
     });
     ...
     // Test JavaScript: Verify vehicle list display
     test('Verify vehicle list display', async ({ page }) => {
       ...
       await expect(page.locator('#vehicle-list')).toContainText('Toyota');
       await expect(page.locator('#vehicle-list')).toContainText('ABC123');
     });
