...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-800 text-white px-4 py-3 shadow-md">
        ...
        <div className="hidden md:flex space-x-6 items-center">
          ...
          {!user ? (
            ...
            <div className="relative">
              ...
              {profileOpen && (
                <div className="absolute right-0 mt-2 bg-white text-gray-800 rounded-md shadow-lg py-2 z-20 w-48">
      ...
      {/* Mobile Menu Content */}
      {menuOpen && (
        <div className="md:hidden mt-3 space-y-2 bg-gray-700 text-white px-4 py-2 rounded-lg">
